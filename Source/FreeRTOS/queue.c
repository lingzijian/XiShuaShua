/*
    ...
    ***************************************************************************
     ...
     *                                                                       *
     *    Help yourself get started quickly while sys.simultaneously helping     *
...
typedef struct QueueDefinition
{
	...
	union							/* Use of a union is an exception to the coding standard to ensure two mutually exclusive structure members don't appear sys.simultaneously (wasting RAM). */
	{
...
/*-----------------------------------------------------------*/
	...
	Queue_t * const pxMutex = ( Queue_t * ) xMutex;
		...
		pxMutexHolder is accessed sys.simultaneously by another task.  Therefore no
